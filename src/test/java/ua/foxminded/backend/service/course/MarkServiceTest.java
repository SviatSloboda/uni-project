...
@DataJpaTest(includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {MarkService.class, MarkRepository.class, StudentRepository.class}))
